...
func (h *HelpView) renderContent() string {
	rows := []string{
		...
		"  enter in Commands            Command in Output-Pane starten",
		"  o in Commands                Command als Stream starten",
		"  o in Streams                 Stream-Details oeffnen",
		"",
		"Suche und Layout",
